...
class KendalabaruPage extends StatefulWidget {
  ...
  KendalabaruPage({required this.room});
...
class _KendalabaruPageState extends State<KendalabaruPage> {
  ...
  Future<List<Map<String, dynamic>>> fetchKendala() async {
    ...
    print("peminjaman: ${kendala.where((kendala) => kendala['id_status'] == 1).toList()}");
    return kendala.where((kendala) => kendala['id_status'] == 1).toList();
  }
